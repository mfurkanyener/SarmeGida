...
export default function Testimonials() {
    ...
    return (
        <section aria-labelledby="testimonials-heading" className="section-y overflow-hidden">
            <div className="mx-auto max-w-5xl px-4 text-center">
                ...
                {/* Animasyonlu içerik */}
                <div className="relative mt-10 h-[160px] flex items-center justify-center">
                    <AnimatePresence mode="wait">
                        ...
                        >
                            <span className="block mx-auto max-w-4xl text-[clamp(20px,2.8vw,40px)] leading-snug">
                                “{active.quote}”
                            </span>
                            <div className="mt-6">
